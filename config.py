...
CSV_BASE_DIR = "csvs"
OUTPUT_DIR_AGG = os.path.join(CSV_BASE_DIR, "aggregate_outputs_csv")
OUTPUT_DIR_OTH_CSV = os.path.join(CSV_BASE_DIR, "others_csv")
OUTPUT_DIR_AGG_NO_OUT = os.path.join(CSV_BASE_DIR, "aggregateNoOutliers_csv")
OUTPUT_DIR_AGG_GT0 = os.path.join(CSV_BASE_DIR, "aggregategreaterthan0")
